...
#define lazy(name) ::li::detail::lazy_function<LAZY_IMPORTER_KHASH(#name), decltype(&name)>()

#define lazy_def(name) ::li::detail::lazy_function<LAZY_IMPORTER_KHASH(#name), name>()

#define lazy_mod(name) ::li::detail::lazy_module<LAZY_IMPORTER_KHASH(name)>()
